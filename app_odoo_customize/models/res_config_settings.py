...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        app_system_name = ir_config.get_param('app_system_name', default='EnrollSimply')
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url',
                                                    default='http://www.enrollsimply.com/')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url',
                                                        default='http://www.enrollsimply.com/')
        app_support_url = ir_config.get_param('app_support_url', default='http://www.enrollsimply.com/')
        app_account_title = ir_config.get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.get_param('app_account_url', default='http://www.enrollsimply.com/')
        app_enterprise_url = ir_config.get_param('app_enterprise_url', default='http://www.enrollsimply.com/')
        res.update(
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_documentation_url",
                            self.app_documentation_url or "http://www.enrollsimply.com/")
        ir_config.set_param("app_documentation_dev_url",
                            self.app_documentation_dev_url or "http://www.enrollsimply.com/")
        ir_config.set_param("app_support_url", self.app_support_url or "http://www.enrollsimply.com/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "http://www.enrollsimply.com/")
        ir_config.set_param("app_enterprise_url", self.app_enterprise_url or "http://www.enrollsimply.com/")
